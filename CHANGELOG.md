...
- README Build & Development section: prerequisites, setup, run extension (F5), and package VSIX.
- MIT LICENSE file.
- Extension icon (`images/xiaobai.png`).
- 
### Fixed

- Formatter: brace-with-content handling now runs before semicolon split, so `Nodes {Master: Master_Node;Slaves: MLX_Node1;}` correctly formats with newline after `{` and one statement per line.
...
[1.0.2]: https://github.com/crazy0104/mlx-mbdf-formatter/compare/v1.0.1...v1.0.2
